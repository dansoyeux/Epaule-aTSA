...
def name(context, Basename, ext):
    """
    function that checks the output file name, if a file with the same name already exists, creates a new file with a number at the end
    
    BaseName : (str) the name of the file to check
