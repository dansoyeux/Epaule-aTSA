...
def additional_calculations(Results):
    ...
    def delt_lateral_angle(Results):
        ...
        for case_name, case_data in Results.items():
            delt_direction_IS_origin = case_data["Muscles"]["Deltoid lateral"]["Deltoid lateral"]["F origin"]["Total_IS"]
            delt_direction_ML_origin = case_data["Muscles"]["Deltoid lateral"]["Deltoid lateral"]["F origin"]["Total_ML"]
            ...
            delt_direction_IS_insertion = case_data["Muscles"]["Deltoid lateral"]["Deltoid lateral"]["F insertion"]["Total_IS"]
            delt_direction_ML_insertion = case_data["Muscles"]["Deltoid lateral"]["Deltoid lateral"]["F insertion"]["Total_ML"]
