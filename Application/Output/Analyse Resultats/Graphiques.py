...
# bug pas de légende des annotations que si dernier graph en a
# muscle_graph(Results_aTSA, "Deltoid lateral", "Abduction", "F insertion", "Direction of the deltoid lateral's force on its insertion", cases_on=CaseNames_3, xlim=[0, 120], grid_x_step=15, subplot={"dimension": [1, 3], "number": 1}, subplot_title="Medial-lateral axis", composante_y=["Total_ML"])
# COP_graph(Results_aTSA, COP_contour, composantes=["AP", "IS"], figure_title="Position of the Center of Pressure on the glenoid implant", cases_on=["xdown-short", "middle-normal", "xup-long"], subplot={"dimension": [1, 3], "number": 2}, annotation_offset=[3, -2.1], annotation_reference_offset=[1, 3], graph_annotation_on=True, COP_first_point_size=15, COP_first_point_mew=4, xlim=[-17, 17], ylim=[-19, 22], grid_x_step=5, figsize=[18, 10], draw_COP_points_on=False)
# muscle_graph(Results_aTSA, "Deltoid lateral", "Abduction", "F insertion", "Direction of the deltoid lateral's force on its insertion", cases_on=CaseNames_3, xlim=[0, 120], grid_x_step=15, subplot={"dimension": [1, 3], "number": 3}, subplot_title="Medial-lateral axis", composante_y=["Total_ML"])

# COP_graph(Results_aTSA, COP_contour, composantes=["AP", "IS"], figure_title="Position of the Center of Pressure on the glenoid implant", cases_on=MiddleCases_5, graph_annotation_on=False, COP_first_point_size=15, COP_first_point_mew=4, xlim=[-17, 17], ylim=[-19, 22], grid_x_step=5, figsize=[18, 10], draw_COP_points_on=False, legend_label_per_column=3)
# COP_graph(Results_aTSA, COP_contour, composantes=["AP", "IS"], figure_title="Position of the Center of Pressure on the glenoid implant", cases_on=MiddleCases_5, graph_annotation_on=False, COP_first_point_size=15, COP_first_point_mew=4, xlim=[-17, 17], ylim=[-19, 22], grid_x_step=5, figsize=[18, 10], draw_COP_points_on=False)

# COP_graph(Results_aTSA, COP_contour, composantes=["AP", "IS"], figure_title="Position of the Center of Pressure on the glenoid implant", cases_on=["middle-normal"], graph_annotation_on=False, COP_first_point_size=20, COP_first_point_mew=4, xlim=[-17, 17], ylim=[-19, 22], grid_x_step=5, figsize=[18, 10], draw_COP_points_on=False, label= "COP_first_point_size=20; COP_first_point_mew=4")
# COP_graph(Results_aTSA, COP_contour, composantes=["AP", "IS"], figure_title="Position of the Center of Pressure on the glenoid implant", cases_on=["xup-normal"], graph_annotation_on=False, COP_first_point_size=20, COP_first_point_mew=8, xlim=[-17, 17], ylim=[-19, 22], grid_x_step=5, figsize=[18, 10], draw_COP_points_on=False, add_graph=True, label= "COP_first_point_size=20; COP_first_point_mew=8")
# COP_graph(Results_aTSA, COP_contour, composantes=["AP", "IS"], figure_title="Position of the Center of Pressure on the glenoid implant", cases_on=["xdown-normal"], graph_annotation_on=False, COP_first_point_size=35, COP_first_point_mew=4, xlim=[-17, 17], ylim=[-19, 22], grid_x_step=5, figsize=[18, 10], draw_COP_points_on=False, add_graph=True, label= "COP_first_point_size=35; COP_first_point_mew=4")
